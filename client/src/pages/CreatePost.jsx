...
const CreatePost = () => {
  ...
  const generateImage= async()=>{
    if(form.prompt){
      try{
        ...
        const response = await fetch('https://ai-image-generator-7a7h.onrender.com/api/v1/dalle',{
          method: 'POST',
          headers: {
  ...
  const handlesubmit = async(e)=>{
    ...
    if(form.prompt && form.photo && form.name){
      setLoading(true);
      try{
        const response = await fetch('https://ai-image-generator-7a7h.onrender.com/api/v1/post',{
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 txt-[#666e75] text-[16px] max-w[500px]'>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handlesubmit}>
        <div className='flex flex-col gap-5'>
          ...
          border-gray-300 text-gray-900 text-smm rounded-lg
          focus:ring-blue-500 focues:border-blue-500 w-64 p-3
        ...
        <div className='mt-10'>
          ...
          Once you have created the image you want, you can share items
          with the community
          </p>  
